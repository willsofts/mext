 ...
 * v1.3a 28 Sep 2006 - George Adamson	- Minor enhancements
 ...
 Sample usage:
	...
	$(document).ready(function(){
		...
		$("#myInputElement").spin(myOptions);

	});
 
 */
$.fn.spin = function(cfg){
	return this.each(function(){
		...
		.mousemove(function(e){
			...
			var left = offset.left; //coord(el,'offsetLeft');
			var top = offset.top; //coord(el,'offsetTop');
			var xdif = left + el.offsetWidth - this.spinCfg._btn_width;
			var ydif = top + el.offsetHeight - this.spinCfg._btn_height;
			var direction = (x > xdif) ? ((y < ydif) ? 1 : -1) : 0;
