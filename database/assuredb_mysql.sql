...
-- Dumping structure for table assuredb2.tkactive
CREATE TABLE IF NOT EXISTS `tkactive` (
...
-- Dumping data for table assuredb2.tkactive: ~2 rows (approximately)
/*!40000 ALTER TABLE `tkactive` DISABLE KEYS */;
INSERT INTO `tkactive` (`activeid`, `nameen`, `nameth`, `seqno`) VALUES
	('0', 'Active', 'ใช้งาน', 1),
	('1', 'Inactive', 'ไม่ใช้งาน', 2);
/*!40000 ALTER TABLE `tkactive` ENABLE KEYS */;

-- Dumping structure for table assuredb2.tkappstype
CREATE TABLE IF NOT EXISTS `tkappstype` (
...
-- Dumping data for table assuredb2.tkappstype: ~2 rows (approximately)
/*!40000 ALTER TABLE `tkappstype` DISABLE KEYS */;
INSERT INTO `tkappstype` (`appstype`, `nameen`, `nameth`, `seqno`) VALUES
	('M', 'Mobile', 'Mobile', 2),
	('W', 'Web', 'Web', 1);
/*!40000 ALTER TABLE `tkappstype` ENABLE KEYS */;

-- Dumping structure for table assuredb2.tkbranchtype
CREATE TABLE IF NOT EXISTS `tkbranchtype` (
...
-- Dumping data for table assuredb2.tkbranchtype: ~3 rows (approximately)
/*!40000 ALTER TABLE `tkbranchtype` DISABLE KEYS */;
INSERT INTO `tkbranchtype` (`branchtype`, `nameen`, `nameth`, `seqno`) VALUES
	('HB', 'Head Branch', 'สำนักงานใหญ่', 1),
	('SB', 'Sub Branch', 'สำนักงานสาขาย่อย', 2),
	('VB', 'Service Branch', 'สำนักงานบริการ', 3);
/*!40000 ALTER TABLE `tkbranchtype` ENABLE KEYS */;

-- Dumping structure for table assuredb2.tkgroupmobile
CREATE TABLE IF NOT EXISTS `tkgroupmobile` (
...
-- Dumping data for table assuredb2.tkgroupmobile: ~4 rows (approximately)
/*!40000 ALTER TABLE `tkgroupmobile` DISABLE KEYS */;
INSERT INTO `tkgroupmobile` (`groupname`, `nameen`, `nameth`, `iconfile`) VALUES
...
/*!40000 ALTER TABLE `tkgroupmobile` ENABLE KEYS */;

-- Dumping structure for table assuredb2.tklanguage
CREATE TABLE IF NOT EXISTS `tklanguage` (
...
-- Dumping data for table assuredb2.tklanguage: ~2 rows (approximately)
/*!40000 ALTER TABLE `tklanguage` DISABLE KEYS */;
INSERT INTO `tklanguage` (`langcode`, `nameen`, `nameth`, `seqno`, `imagefile`) VALUES
	('EN', 'English', 'อังกฤษ', 1, 'EN.png'),
	('TH', 'Thai', 'ไทย', 2, 'TH.png');
/*!40000 ALTER TABLE `tklanguage` ENABLE KEYS */;

-- Dumping structure for table assuredb2.tkpermit
CREATE TABLE IF NOT EXISTS `tkpermit` (
...
-- Dumping data for table assuredb2.tkpermit: ~8 rows (approximately)
/*!40000 ALTER TABLE `tkpermit` DISABLE KEYS */;
INSERT INTO `tkpermit` (`permname`, `nameen`, `nameth`, `seqno`) VALUES
	('all', 'Alls', 'ทั้งหมด', 7),
	('delete', 'Delete', 'ลบ', 3),
...
/*!40000 ALTER TABLE `tkpermit` ENABLE KEYS */;

-- Dumping structure for table assuredb2.tkprogtype
CREATE TABLE IF NOT EXISTS `tkprogtype` (
...
-- Dumping data for table assuredb2.tkprogtype: ~13 rows (approximately)
/*!40000 ALTER TABLE `tkprogtype` DISABLE KEYS */;
INSERT INTO `tkprogtype` (`progtype`, `nameen`, `nameth`, `seqno`) VALUES
	('C', 'Script', 'สคริปส์', 11),
...
/*!40000 ALTER TABLE `tkprogtype` ENABLE KEYS */;

-- Dumping structure for table assuredb2.tkrxstatus
CREATE TABLE IF NOT EXISTS `tkrxstatus` (
...
-- Dumping data for table assuredb2.tkrxstatus: ~4 rows (approximately)
/*!40000 ALTER TABLE `tkrxstatus` DISABLE KEYS */;
INSERT INTO `tkrxstatus` (`statusid`, `nameen`, `nameth`, `seqno`) VALUES
	('C', 'Completed', 'Completed', 1),
	('E', 'Error', 'Error', 3),
	('N', 'Not Complete', 'Not Complete', 2),
	('R', 'Response', 'Response', 4);
/*!40000 ALTER TABLE `tkrxstatus` ENABLE KEYS */;

-- Dumping structure for table assuredb2.tksystemtype
CREATE TABLE IF NOT EXISTS `tksystemtype` (
...
-- Dumping data for table assuredb2.tksystemtype: ~3 rows (approximately)
/*!40000 ALTER TABLE `tksystemtype` DISABLE KEYS */;
INSERT INTO `tksystemtype` (`systemtype`, `nameen`, `nameth`, `seqno`) VALUES
	('A', 'Android', 'Android', 1),
	('I', 'iOS', 'iOS', 2),
	('W', 'Web', 'Web', 3);
/*!40000 ALTER TABLE `tksystemtype` ENABLE KEYS */;

-- Dumping structure for table assuredb2.tkuserstatus
CREATE TABLE IF NOT EXISTS `tkuserstatus` (
...
-- Dumping data for table assuredb2.tkuserstatus: ~3 rows (approximately)
/*!40000 ALTER TABLE `tkuserstatus` DISABLE KEYS */;
INSERT INTO `tkuserstatus` (`userstatus`, `nameen`, `nameth`, `seqno`) VALUES
	('A', 'Activated', 'ใช้งาน', 1),
	('C', 'Closed', 'ปิดการใช้งาน', 2),
	('P', 'Pending', 'ระงับการใช้งาน', 3);
/*!40000 ALTER TABLE `tkuserstatus` ENABLE KEYS */;

-- Dumping structure for table assuredb2.tkusertype
CREATE TABLE IF NOT EXISTS `tkusertype` (
...
-- Dumping data for table assuredb2.tkusertype: ~12 rows (approximately)
/*!40000 ALTER TABLE `tkusertype` DISABLE KEYS */;
INSERT INTO `tkusertype` (`usertype`, `nameen`, `nameth`, `level`) VALUES
	...
	('Z', 'Client', 'ลูกค้า', 5);
/*!40000 ALTER TABLE `tkusertype` ENABLE KEYS */;

-- Dumping structure for table assuredb2.tkvisible
CREATE TABLE IF NOT EXISTS `tkvisible` (
...
-- Dumping data for table assuredb2.tkvisible: ~2 rows (approximately)
/*!40000 ALTER TABLE `tkvisible` DISABLE KEYS */;
INSERT INTO `tkvisible` (`visibleid`, `nameen`, `nameth`, `seqno`) VALUES
	('0', 'Visible', 'มองเห็น', 1),
	('1', 'Invisible', 'มองไม่เห็น', 2);
/*!40000 ALTER TABLE `tkvisible` ENABLE KEYS */;
